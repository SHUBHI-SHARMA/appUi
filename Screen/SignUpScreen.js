...
//               fetch(`http://103.155.73.35:5000/ms/?ms=${res}&IMEI=${userToken}`).then(resp=>{
//                 console.log("pinged");
//             })
//             } catch(e) {
//               console.log(e);
...
//         // fetch('http://103.155.73.35:4000/api/register/',{
//         //     method: 'POST',
//         //     headers: {
//         //         'Accept': 'application/json, text/plain, */*',  // It can be used to overcome cors errors
//         //         'Content-Type': 'application/json'
...
//         else{
//             setloading(true);
//             RNFetchBlob.fetch("POST",`http://103.155.73.35:4000/api/register/?email=${userName}&password=${password}&IMEI=${id}&phone=${phone}`,{
//                 'Accept': 'application/json, text/plain, */*',  // It can be used to overcome cors errors
//                 'Content-Type': 'application/json',
//                 'AuthToken' :enc
//             })
